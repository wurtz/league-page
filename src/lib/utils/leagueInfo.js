...
export const managers = [
    {
     // "roster": 3,  // (DEPRECATED! Don't use this anymore) ID of the roster that the manager manages (look at the order of the power rankings graph)
      ...
      "bio": "<b><i>Original Dirty Dozen member</i></b>. Founding father and real father to the commish. Notorious for taking Bills players (maybe a little too early sometimes). Certified waiver wire shark. <br><br> Year number two of the league, David attempts to draft Peyton Manning fresh into his Denver career. He drafts Eli on accident. Brad drafts Peyton with the following pick. Week 1 Brad plays David. Peyton throws for 462 yards and 7 TDs that week.",
...
//    "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
 ...
 //    "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
     ...
     // "roster": 3,  // (DEPRECATED! Don't use this anymore) ID of the roster that the manager manages (look at the order of the power rankings graph)
      ...
      "bio": "<b><i>Original Dirty Dozen member</i></b>. Corey's and David met back in college at FGCU. In the original Dirty Dozen days Corey, David and Groovy would spend entire football Sundays at the bar of Wicked Wings. Corey's won multiple championships in the league and rarely misses playoffs. Don't trust Corey.",
...
//      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
     ...
     // "roster": 3,  // (DEPRECATED! Don't use this anymore) ID of the roster that the manager manages (look at the order of the power rankings graph)
      ...
      "bio": "Dan can be found on Sundays taking bourbon shots with old bay rims. What's he eating? Crab Soup, Crab Cakes, with a side of Crab chips. We get it Dan... you're from DMV. It's looking like the Washington [INSERT CURRENT TEAM NAME] finally found their franchise QB in Jayden Daniels. Dan saw him live once and he got injured. Don't go to anymore games Dan, it's not worth it.",
