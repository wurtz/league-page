...
export const managers = [
    {
     // "roster": 3,  // (DEPRECATED! Don't use this anymore) ID of the roster that the manager manages (look at the order of the power rankings graph)
      ...
      "bio": "Original Dirty Dozen member. Founding father and real father to the commish. Notorious for taking Bills players (maybe a little too early sometimes). Certified waiver wire shark. <br> Year number two of the league, David attempts to draft Peyton Manning fresh into his Denver career. He drafts Eli on accident. Brad drafts Peyton with the following pick. Week 1 Brad plays David. Peyton throws for 462 yards and 7 TDs.",
